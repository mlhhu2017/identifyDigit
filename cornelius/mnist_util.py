...
#
# outputs:
#   train           ndarray with shape (60000,784), trainings images
#   train_labels    ndarray with shape (60000,),    training labels
#   test            ndarray with shape (10000,784), test images
#   test_labels     ndarray with shape (10000,),    test labels
#
...
#
# inputs:
#   num    takes a (784,) shape ndarray (a row)
#
# outputs:
...
#
# inputs:
#   data      takes a (n,784) shape ndarray (multiple rows)
